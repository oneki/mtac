...
public class BaseDbRelationDeserializer extends DelegatingDeserializer /* implements ContextualDeserializer */ {

    private JavaType type;
    private BeanDescription beanDescription;
    private final ObjectMapper entityMapper;

    public BaseDbRelationDeserializer(BeanDescription beanDescription, JsonDeserializer<?> originalDeserializer, ObjectMapper entityMapper) {
    ...
    protected JsonDeserializer<?> newDelegatingInstance(JsonDeserializer<?> newDelegate) {
        return new BaseDbRelationDeserializer(beanDescription, newDelegate, entityMapper);
    }
