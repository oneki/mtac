...
import net.oneki.mtac.core.util.security.DefaultJwtAuthoritiesExtractor;
import net.oneki.mtac.core.util.security.JwtAuthenticationManager;
import net.oneki.mtac.core.util.security.JwtAuthoritiesExtractor;
import net.oneki.mtac.core.util.security.SecurityContext;
import net.oneki.mtac.core.util.security.DefaultJwtAuthoritiesExtractor.AuthorityKey;
