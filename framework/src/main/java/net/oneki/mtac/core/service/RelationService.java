package net.oneki.mtac.core.service;
...
import net.oneki.mtac.core.framework.ResourceEmbedded;
import net.oneki.mtac.core.model.framework.RelationLabel;
import net.oneki.mtac.core.model.framework.RelationRefs;
import net.oneki.mtac.core.model.framework.Relations;
import net.oneki.mtac.core.repository.ResourceRepository;
import net.oneki.mtac.resource.Resource;
import net.oneki.mtac.core.util.ResourceUtils;
