...
import net.oneki.mtac.core.util.exception.ICustomException;
import net.oneki.mtac.core.util.exception.JsonException;
import net.oneki.mtac.core.util.exception.JsonExceptionConvertible;
import net.oneki.mtac.core.util.exception.TechnicalException;
